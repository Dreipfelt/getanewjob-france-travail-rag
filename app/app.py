...
st.title("GetANewJob")
st.caption(
    "Recherche hybride (sémantique + mots-clés) avec reclassement, et "
    "scoring motivé d'offres d'emploi data, à partir de l'API France Travail."
)
st.caption(
        ...
        for r in resultats:
            with st.container(border=True):
                ...
                st.caption(
                    ...
                    f"score reclassement : {r['score_rerank']:.4f} · "
